...
## Logic Used to Detect Buy/Sell Trend
This project uses RSI,  calculation:
- **Moving Averages (MA):** Two averages are calculated: a short-term (20 days) and a long-term (50 days).
- **Slope Logic (RSI):** The slope of the long-term moving average is computed. If the slope is positive and above a threshold, the stock is in an uptrend. If negative and below a threshold, it's a downtrend. Otherwise, it's sideways.
